...
public abstract class NotificationServiceComponent implements NotificationService{
    ...
    public NotificationServiceComponent(){
        this.Repository = new RepositoryUtil<Notification>(Reservation.notification.core.model.NotificationComponent.class);
    }	
    ...
    public abstract HashMap<String, Object> getNotification(Map<String, Object> requestBody);
