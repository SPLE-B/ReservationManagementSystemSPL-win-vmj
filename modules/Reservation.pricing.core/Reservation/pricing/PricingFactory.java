...
public class PricingFactory {
	 private static final Logger LOGGER = Logger.getLogger(PricingFactory.class.getName());

	public PricingFactory() {}

	 public static Pricing createPricing(String fullyQualifiedName, Object ... base)
    {
        Pricing record = null;
		try {
            ...
            for (int i = 0; i < constructorList.length; i++) {
              try {
            	...
            	record = (Pricing) constructor.newInstance(base);
            ...
            LOGGER.severe("Failed to create instance of Pricing.");
