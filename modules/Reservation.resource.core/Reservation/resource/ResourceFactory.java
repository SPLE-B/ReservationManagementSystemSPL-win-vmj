...
public class ResourceFactory {
	...
	public ResourceFactory() {}
	 ...
	 public static Resource createResource(String fullyQualifiedName, Object ... base)
    {
		...
		try {
            ...
            for (int i = 0; i < constructorList.length; i++) {
              try {
            	...
            	record = (Resource) constructor.newInstance(base);
            ...
            LOGGER.severe("Failed to create instance of Resource.");
