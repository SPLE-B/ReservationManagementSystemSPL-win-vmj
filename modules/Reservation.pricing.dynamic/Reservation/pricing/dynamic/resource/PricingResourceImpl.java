...
public class PricingResourceImpl extends PricingResourceDecorator {
	private PricingServiceComponent pricingdynamicServiceImpl;

    public PricingResourceImpl (PricingResourceComponent record, PricingServiceComponent recordService) {
        super(record);
		this.pricingdynamicServiceImpl = new PricingServiceImpl(recordService);
    }
