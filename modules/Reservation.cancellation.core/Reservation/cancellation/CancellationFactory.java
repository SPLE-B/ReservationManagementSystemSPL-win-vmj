...
public class CancellationFactory {
	 private static final Logger LOGGER = Logger.getLogger(CancellationFactory.class.getName());

	public CancellationFactory() {}

	 public static Cancellation createCancellation(String fullyQualifiedName, Object ... base)
    {
        Cancellation record = null;
		try {
            ...
            for (int i = 0; i < constructorList.length; i++) {
              try {
            	...
            	record = (Cancellation) constructor.newInstance(base);
            ...
            LOGGER.severe("Failed to create instance of Cancellation.");
