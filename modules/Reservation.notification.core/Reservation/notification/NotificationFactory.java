...
public class NotificationFactory {
	...
	public NotificationFactory() {}
	 ...
	 public static Notification createNotification(String fullyQualifiedName, Object ... base)
    {
		...
		try {
            ...
            for (int i = 0; i < constructorList.length; i++) {
              try {
            	...
            	record = (Notification) constructor.newInstance(base);
            ...
            LOGGER.severe("Failed to create instance of Notification.");
